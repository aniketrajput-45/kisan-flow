...
export const LoginScreen = ({ onSwitchToRegister }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!cleanPhone || !password) {
      setError('Please enter both mobile phone number and password.');
      return;
    }
  ...
  const fillDemoFarmer = () => {
    ...
    setAutoFilled(true);
    setError(null);
    setTimeout(() => setAutoFilled(false), 3500);
  };
          ...
          <View style={[styles.card, darkMode && styles.cardDark]}>
            ...
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardSub}>
                Enter your mobile number and password to manage mandi procurement slots
              </Text>
            </View>

            {/* Instant Demo Account Card */}
            <TouchableOpacity
            ...
            >
              <View style={styles.demoLeft}>
                <View style={styles.demoBadge}>
                  <Text style={styles.demoBadgeText}>⚡ INSTANT DEMO ACCOUNT</Text>
                </View>
                <Text style={styles.demoTitle}>Ramesh Kumar (Farmer)</Text>
                <Text style={styles.demoSub}>Mobile: 9876543210  |  Pass: password123</Text>
              </View>
            ...
            >
              ...
              {loading ? (
                ...
                <Text style={styles.submitBtnText}>Login to Farmer Portal ➔</Text>
              )}
            </TouchableOpacity>
            ...
            <View style={styles.trustBadgesRow}>
              ...
              <View style={styles.trustBadge}>
                <Text style={styles.trustIcon}>⚡</Text>
                <Text style={styles.trustText}>Instant Pass</Text>
              </View>
            </View>
